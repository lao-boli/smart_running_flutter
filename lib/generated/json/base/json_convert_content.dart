...
class JsonConvert {
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    if (<Role>[] is M) {
      return data.map<Role>((Map<String, dynamic> e) => Role.fromJson(e))
          .toList() as M;
    }
    if (<TrainRecord>[] is M) {
      return data.map<TrainRecord>((Map<String, dynamic> e) =>
          TrainRecord.fromJson(e)).toList() as M;
    }
    if (<Unit>[] is M) {
      return data.map<Unit>((Map<String, dynamic> e) => Unit.fromJson(e))
          .toList() as M;
    }
    if (<User>[] is M) {
...
class JsonConvertClassCollection {
  Map<String, JsonConvertFunction> convertFuncMap = {
    (Role).toString(): Role.fromJson,
    (TrainRecord).toString(): TrainRecord.fromJson,
